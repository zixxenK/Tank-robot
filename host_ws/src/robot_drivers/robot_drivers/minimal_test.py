#!/usr/bin/env python3
"""Minimal inline test for core components."""
...
def test_frame_building():
    ...
    assert len(frame) == 5  # 2 sync + 2 header + 0 payload + 1 crc
    assert frame[0] == SYNC_1
    assert frame[1] == SYNC_2
    print("Frame building: OK")

if __name__ == '__main__':
    print("Running minimal component tests...")
    test_crc()
    test_frame_building()
