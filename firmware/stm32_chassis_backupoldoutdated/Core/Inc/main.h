...
/*
 * Bring-up mode gates.
 * Set BRINGUP_MODE_BLINK_ONLY to 1 for a pure GPIO blink smoke test.
 */
#define BRINGUP_MODE_BLINK_ONLY       0u
#define BRINGUP_BLINK_GPIO_ENABLE     1u
#define BRINGUP_BLINK_PERIOD_MS       500u
#define BRINGUP_LED_PIN               GPIO_PIN_13
