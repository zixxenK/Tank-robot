...
| Component | Role |
|-----------|------|
| **STM32F407** | Real-time motor control, encoder feedback, micro-ROS UART agent |
...
│   ├── stm32_chassis/                   # Micro-ROS firmware for STM32F407
│   │   ├── Core/
│   │   │   ├── Inc/                     # HAL + motor driver headers
│   │   │   ├── Src/                     # HAL + motor driver sources
│   │   │   └── STM32F407VGTx_FLASH.ld  # Linker script
│   │   ├── micro_ros_lib/
│   │   │   └── libmicroros.a            # Pre-compiled micro-ROS (gitignored)
│   │   ├── cmake/
...
|---|-------------|------|-------------|
| 1b | STM32 micro-ROS lib | `firmware/stm32_chassis/CMakeLists.txt:50` | Static lib path |
