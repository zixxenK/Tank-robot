...
- Whether the Rock64↔STM32 link over USART2 at 1Mbaud is a custom packet protocol or reuses any of
  Hiwonder's open-source ROS SDK framing. **USART2 IS USED FOR ROCK64 CONNECTION (NOT USART3)**
